...
public partial class P3D_Main
{
	...
	private void DrawClear()
	{
		...
		if (GUI.Button(rect, "Clear Color") == true)
		{
			var menu = new GenericMenu();

			menu.AddItem(new GUIContent("Transparent"), false, () => { ClearTexture(P3D_Helper.GetColor(P3D_Helper.BaseColors.Transparent)); });
			menu.AddItem(new GUIContent("Black"      ), false, () => { ClearTexture(P3D_Helper.GetColor(P3D_Helper.BaseColors.Black      )); });
			menu.AddItem(new GUIContent("White"      ), false, () => { ClearTexture(P3D_Helper.GetColor(P3D_Helper.BaseColors.White      )); });
			menu.AddItem(new GUIContent("Normal"     ), false, () => { ClearTexture(P3D_Helper.GetColor(P3D_Helper.BaseColors.Normal     )); });
	...
	private void ClearTexture(Color color, bool recordUndo = true)
	{
		if (currentTexture != null)
		{
